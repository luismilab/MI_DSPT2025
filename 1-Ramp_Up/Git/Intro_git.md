...
Antes de profundizar en los comandos de Git, aquí te dejo algunos conceptos básicos que debes conocer:
...
- **Branch**: Un branch es una versión paralela de un repositorio. Se utiliza para trabajar en diferentes versiones de un proyecto simultáneamente.
